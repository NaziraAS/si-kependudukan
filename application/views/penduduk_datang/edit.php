<div class="container">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                <div class="card-body">
                    <form action="<?= base_url('penduduk_datang/editsave/') . $edit['id'] ?>" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" id="tanggal" value="<?= $edit['tgl'] ?>" placeholder="Tanggal" name="tanggal">
                            <?= form_error('nik', '<div class="text-danger">', '</div>') ?>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nosurat" value="<?= $edit['nomor_surat'] ?>" placeholder="Alamat tujuan" name="nosurat">
